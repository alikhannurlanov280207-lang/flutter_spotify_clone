...
import 'package:flutter_project/presentation/home/bloc/news_songs_cubit.dart';
...
class NewsSongs extends StatelessWidget {
  ...
  Widget _songs(List<SongEntity> songs) {
    ...
    final List<String> imageUrls = [
      '${AppURLs.firestorage1}BillieEilish,Khalid - lovely.jpg',
      '${AppURLs.firestorage3}Drake - In My Feelings.jpg',
      '${AppURLs.firestorage2}EdSheeran - Shape Of You.jpg',
    ];

    return ListView.builder(
      scrollDirection: Axis.horizontal,
      itemCount: imageUrls.length, // Используйте длину списка
      itemBuilder: (context, index) {
        return Padding(
          padding: const EdgeInsets.only(right: 17.0), // Отступ справа между изображениями
